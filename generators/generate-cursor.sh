#!/bin/bash
# =============================================================================
# Generate .cursorrules from brain.yaml and templates
# =============================================================================
# Usage: generate-cursor.sh [vault_path] [brain_project_path]
...
TEMPLATE="$SCRIPT_DIR/templates/cursorrules.tmpl"
...
# Write output
OUTPUT_FILE="$VAULT_PATH/.cursorrules"
