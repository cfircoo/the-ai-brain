#!/bin/bash
# =============================================================================
# Generate CLAUDE.md from brain.yaml and templates
# =============================================================================
# Usage: generate-claude.sh [vault_path] [brain_project_path]
...
TEMPLATE="$SCRIPT_DIR/templates/CLAUDE.md.tmpl"
...
# Write output
OUTPUT_FILE="$VAULT_PATH/CLAUDE.md"
