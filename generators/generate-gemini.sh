#!/bin/bash
# =============================================================================
# Generate GEMINI.md from brain.yaml and templates
# =============================================================================
# Usage: generate-gemini.sh [vault_path] [brain_project_path]
...
TEMPLATE="$SCRIPT_DIR/templates/gemini.md.tmpl"
...
# Write output
OUTPUT_FILE="$VAULT_PATH/GEMINI.md"
